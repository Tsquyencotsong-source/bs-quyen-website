...
const ARTICLES: Record<string, Block[]> = {
  ...
  "nang-nong-lam-dau-lung-dau-khop-te-hon": [
    {
      type: "para",
      content: "Đây là điều tôi nghe rất nhiều trong phòng khám mỗi mùa hè: Bác sĩ ơi, tôi không làm gì nặng hết, chỉ ngồi điều hòa cả ngày mà sao lưng lại đau hơn mọi khi? Hoặc: Trời nóng thế này mà sao khớp gối lại sưng phù lên vậy bác sĩ?",
    },
    {
      type: "para",
      content: "Trực giác mách bảo chúng ta rằng nắng nóng không liên quan đến đau lưng và đau khớp. Nhưng khoa học nói điều ngược lại. Mùa hè — với nhiệt độ cao, mất nước, thói quen sinh hoạt thay đổi và việc ra vào điều hòa liên tục — tạo ra một loạt tác động lên cột sống và khớp mà ít ai ngờ tới. Bài này tôi sẽ giải thích cơ chế từng bước, để bệnh nhân hiểu tại sao cơn đau quen thuộc lại trở nên tệ hơn vào mùa nắng nóng.",
    },
    {
      type: "heading",
      content: "Cơ Chế 1: Đĩa Đệm Cột Sống Mất Nước — Nghĩa Đen, Không Phải Nghĩa Bóng",
    },
    {
      type: "para",
      content: "Đĩa đệm — lớp sụn nằm giữa các đốt sống — có thành phần chủ yếu là nước, chiếm khoảng 75-80% ở người trẻ. Chức năng của nó giống như chiếc gối thủy lực: hấp thụ lực nén, phân phối tải trọng đều ra các đốt sống và cho phép cột sống cử động linh hoạt. Nước trong đĩa đệm không cố định — nó trao đổi liên tục với hệ tuần hoàn xung quanh, phụ thuộc trực tiếp vào lượng nước trong cơ thể.",
    },
    {
      type: "highlight",
      content: "Khi cơ thể mất nước do nắng nóng và mồ hôi, đĩa đệm là một trong những nơi đầu tiên bị ảnh hưởng. Đĩa đệm mất nước, xẹp xuống, mỏng đi, giảm khả năng đệm lực. Các đốt sống tiếp xúc gần nhau hơn, dây chằng căng ra, rễ thần kinh bị kéo căng. Kết quả: đau lưng âm ỉ tăng lên, cứng lưng buổi sáng kéo dài hơn, và người có thoát vị đĩa đệm sẵn có sẽ thấy triệu chứng xấu đi rõ rệt.",
    },
    {
      type: "para",
      content: "Điều đáng lo ngại hơn: nghiên cứu đăng trên tạp chí Spine cho thấy tình trạng mất nước mãn tính — uống không đủ nước nhiều tháng liên tục — có thể đẩy nhanh quá trình thoái hóa đĩa đệm, làm đĩa đệm mất đàn hồi vĩnh viễn. Đây là lý do tôi luôn hỏi bệnh nhân đau lưng mãn tính: Bạn uống bao nhiêu nước mỗi ngày?",
    },
    {
      type: "heading",
      content: "Cơ Chế 2: Nhiệt Độ Cao Kích Hoạt Viêm — Đặc Biệt Với Khớp Đã Tổn Thương",
    },
    {
      type: "para",
      content: "Nhiều người nghĩ nhiệt độ cao sẽ giúp khớp dễ chịu hơn vì làm giãn cơ. Điều đó đúng ở nhiệt độ vừa phải, dùng có kiểm soát — như chườm ấm hay ngâm nước ấm. Nhưng khi nhiệt độ môi trường quá cao kéo dài, cơ chế lại đảo ngược.",
    },
    {
      type: "para",
      content: "Nhiệt độ cao kích thích mạch máu giãn nở, tăng lưu lượng máu đến khớp. Ở người khớp bình thường, điều này không gây vấn đề. Nhưng ở người đã có viêm khớp thoái hóa, viêm khớp dạng thấp hay bất kỳ tình trạng viêm khớp nào, dòng máu tăng mang thêm các cytokine gây viêm đến khớp — làm cho phản ứng viêm bùng phát mạnh hơn, khớp sưng nhiều hơn, đau nặng hơn. Độ ẩm cao kèm theo nắng nóng làm trầm trọng thêm, vì cơ thể khó thoát nhiệt, thân nhiệt cốt lõi tăng, phản ứng viêm dữ dội hơn.",
    },
    {
      type: "list",
      items: [
        "Viêm khớp thoái hóa (osteoarthritis): Sụn khớp đã mỏng, tiếp xúc xương nhiều hơn, nhiệt độ cao làm dịch khớp giảm độ nhớt, tăng ma sát. Đau gối, đau háng, đau cột sống tăng rõ trong ngày nắng nóng.",
        "Viêm khớp dạng thấp (rheumatoid arthritis): Hệ miễn dịch vốn đã kích hoạt quá mức, nhiệt nóng thêm vào càng khuếch đại phản ứng viêm. Khớp ngón tay, cổ tay, gối có thể sưng đỏ bùng phát trong đợt nắng nóng.",
        "Thoát vị đĩa đệm đang điều trị: Rễ thần kinh bị chèn ép vốn đã nhạy cảm. Viêm do nhiệt làm tăng phù nề xung quanh rễ thần kinh, đau lan xuống chân hoặc tay nặng hơn.",
        "Gút (gouty arthritis): Mất nước làm tăng nồng độ acid uric trong máu, kết hợp nhiệt độ cao là điều kiện hoàn hảo để cơn gút cấp bùng phát.",
      ],
    },
    {
      type: "heading",
      content: "Cơ Chế 3: Thói Quen Trong Mùa Hè Người Việt Đang Làm Hại Cột Sống",
    },
    {
      type: "para",
      content: "Ngoài cơ chế sinh lý, còn có một nhóm nguyên nhân ít được nói đến: những thói quen sinh hoạt mùa hè điển hình tại Việt Nam đang trực tiếp làm cột sống và khớp tổn thương hơn.",
    },
    {
      type: "warning",
      content: "Thói quen nguy hiểm nhất: Ngồi điều hòa cả ngày, nhiệt độ phòng để 18-20 độ C, rồi bước ra ngoài trời 38-40 độ C. Sự chênh lệch nhiệt độ đột ngột 18-20 độ khiến cơ cạnh sống co rút đột ngột, co thắt cơ, giảm lưu lượng máu đến đĩa đệm. Đây là nguyên nhân hàng đầu gây cơn đau lưng cấp tính vào mùa hè mà bệnh nhân không hiểu tại sao.",
    },
    {
      type: "list",
      items: [
        "Nhiệt độ điều hòa quá thấp (dưới 24 độ C): Co cơ, giảm tuần hoàn máu, giảm tiết dịch khớp. Ngồi lâu trong phòng lạnh mà không vận động là công thức hoàn hảo cho cơn đau lưng.",
        "Uống nước lạnh hoặc đá liên tục: Gây co thắt cơ thực quản và cơ xung quanh cột sống cổ, có thể làm nặng thêm các triệu chứng thoái hóa cột sống cổ.",
        "Nằm quạt hay điều hòa thổi trực tiếp vào lưng khi ngủ: Gió lạnh tập trung vào vùng thắt lưng làm co cơ kéo dài nhiều giờ, sáng dậy đau lưng nặng.",
        "Ít vận động hơn vì trời nóng: Cơ bắp yếu đi, mất đi lớp đệm bảo vệ cột sống. Cột sống mất hỗ trợ cơ, tải trọng dồn hết lên đĩa đệm và khớp.",
        "Ngủ muộn, ngủ ít vì nóng: Giấc ngủ là lúc cột sống phục hồi và đĩa đệm tái hấp thu nước. Thiếu ngủ làm quá trình này không hoàn thiện.",
        "Mang dép lê đế mỏng đi nhiều trong mùa hè: Thiếu hỗ trợ vòm bàn chân làm tăng lực chấn động lên khớp gối và cột sống với mỗi bước đi.",
      ],
    },
    {
      type: "heading",
      content: "Bác Sĩ Khuyên Gì? 8 Điều Chỉnh Cụ Thể Cho Bệnh Nhân Cột Sống Và Khớp",
    },
    {
      type: "para",
      content: "Tin tốt là một khi đã hiểu cơ chế, việc phòng ngừa trở nên rất cụ thể và dễ thực hiện. Với bệnh nhân đang theo dõi hoặc điều trị các bệnh lý cột sống và khớp tại phòng khám, tôi khuyến nghị như sau:",
    },
    {
      type: "list",
      items: [
        "Uống nước trước khi khát — 2 đến 2.5 lít mỗi ngày, chia đều suốt ngày. Không chờ đến khi khát vì lúc đó đĩa đệm đã bắt đầu mất nước. Cân nhắc bổ sung điện giải nhẹ nếu ra mồ hôi nhiều.",
        "Để nhiệt độ điều hòa ở 26-28 độ C, không thấp hơn. Chênh lệch nhiệt độ trong ngoài nhà không được quá 8-10 độ C để tránh co thắt cơ cột sống đột ngột.",
        "Đứng dậy và đi lại 5 phút mỗi 45-60 phút dù đang trong phòng điều hòa. Ngồi tĩnh lâu dù môi trường mát vẫn gây tăng áp lực nội đĩa đệm.",
        "Không để quạt hay điều hòa thổi trực tiếp vào lưng khi ngủ. Dùng khăn mỏng che vùng thắt lưng nếu phải để điều hòa ban đêm.",
        "Duy trì bài tập phục hồi chức năng nhưng chuyển vào trong nhà. Bơi lội trong hồ bơi có mái che là lựa chọn lý tưởng nhất cho bệnh nhân cột sống và khớp trong mùa hè.",
        "Chọn giày dép có đệm lót tốt, hỗ trợ vòm bàn chân khi ra ngoài. Tránh dép lê đế phẳng khi đi bộ quãng dài.",
        "Chườm mát (không phải chườm đá) lên khớp sưng nóng: Khăn ướt nước mát hoặc túi lạnh bọc khăn, chườm 15-20 phút, cách mỗi 2 giờ. Giúp giảm viêm tại chỗ hiệu quả.",
        "Nếu đang dùng thuốc kháng viêm NSAID: Uống kèm thật nhiều nước, không bỏ bữa trước khi uống, và báo ngay bác sĩ nếu nước tiểu giảm hoặc màu vàng sẫm — đây là dấu hiệu thận đang chịu áp lực.",
      ],
    },
    {
      type: "heading",
      content: "Khi Nào Cần Đến Gặp Bác Sĩ Ngay?",
    },
    {
      type: "para",
      content: "Không phải mọi cơn đau tăng lên trong mùa hè đều có thể tự xử lý tại nhà. Có một số dấu hiệu cần được đánh giá y tế sớm, không nên chờ đợi:",
    },
    {
      type: "list",
      items: [
        "Đau lưng cấp tính đột ngột không rõ nguyên nhân, kèm tê bì lan xuống chân hoặc lên tay.",
        "Khớp sưng to, nóng đỏ kèm sốt — có thể là viêm khớp nhiễm khuẩn, một cấp cứu y tế.",
        "Đau không giảm sau khi nghỉ ngơi, uống đủ nước và dùng thuốc giảm đau thông thường 48-72 giờ.",
        "Xuất hiện yếu cơ, không giữ được đồ vật, hoặc đi lại khó khăn hơn bình thường.",
        "Nước tiểu màu nâu sẫm kèm đau cơ dữ dội — nguy cơ tiêu cơ vân do nắng nóng.",
      ],
    },
    {
      type: "note",
      content: "Tóm lại: Nắng nóng làm đĩa đệm mất nước, kích hoạt viêm khớp và tạo điều kiện cho những thói quen xấu gây hại cột sống. Hiểu đúng cơ chế giúp bệnh nhân phòng ngừa đúng chỗ. Nếu bạn đang điều trị bệnh lý cột sống hoặc khớp và thấy triệu chứng nặng hơn trong mùa hè, đừng nghĩ đó là chuyện bình thường phải chịu đựng — hãy liên hệ bác sĩ để điều chỉnh phác đồ phù hợp với mùa.",
    },
    {
      type: "para",
      content: "TS.BS. Nguyễn Ngọc Quyền — Phó Chủ nhiệm Khoa C1.1-A, Bệnh viện TWQĐ 108. Chuyên khoa Cột sống và Phục hồi chức năng Chỉnh hình. Liên hệ: 0989 052 288.",
    },
  ],
